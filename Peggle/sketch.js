...
function ScaleAndRedraw(){
  ...
  ctx.drawImage(image, currImgX , currImgY, image.width * currScale ,image.height * currScale , currImgX , currImgY, image.width * currScale, image.height * currScale);
...
/* 
      första 2 var på källbild som övre vänstra är
      
      3-4 är hur mycket av bilkden skall vidsas

      5-6 övre vänstra plats i canvas

      7*8 är hur stor den skall bli i canvas */


      ctx.drawImage(image, currImgX , currImgY, image.width ,image.height , currImgX , currImgY, image.width, image.height);
      mstartX = e.pageX;
      mstartY = e.pageY;
    }
});
